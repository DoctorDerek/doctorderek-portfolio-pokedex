export default function ThemeToggleArtwork() {
  return (
    <svg
      ...
      className="pokedex-theme-toggle-artwork"
    >
      <mask
      ...
      <g mask="url(#theme-toggle-mask)">
        ...
        <circle
          ...
          cy="37.5"
          r="19.5"
          fill="url(#pokedex-theme-toggle-sun-gradient)"
          className="pokedex-theme-toggle-sun"
        />
        <path
          d="M33.5 29L9 70V81H186.5V70L173 19L151.5 66L136 34L117.5 70L103 23L79.5 70L65 38L48.5 70L33.5 29Z"
          fill="#729971"
          className="pokedex-theme-toggle-mountain3"
        />
        <path
        ...
        <path
          ...
          fill="#092B08"
          className="pokedex-theme-toggle-trees"
        />
        <path
          ...
          fill="white"
          className="pokedex-theme-toggle-cloud2"
        />
        <path
          ...
          fill="white"
          className="pokedex-theme-toggle-cloud1"
        />
        <rect
          x="154"
          y="28"
          ...
          fill="white"
          className="pokedex-theme-toggle-star1"
        />
        <rect
          x="135"
          y="24"
          ...
          fill="white"
          className="pokedex-theme-toggle-star2"
        />
        <rect
          x="143"
          y="12"
          ...
          fill="white"
          className="pokedex-theme-toggle-star3"
        />
        <rect
          x="125"
          y="6"
          ...
          fill="white"
          className="pokedex-theme-toggle-star4"
        />
        <rect
          x="114"
          y="20"
          ...
          fill="white"
          className="pokedex-theme-toggle-star5"
        />
        <rect
          x="15"
          y="16"
          ...
          fill="white"
          className="pokedex-theme-toggle-star6"
        />
        <rect
          x="29"
          y="22"
          ...
          fill="white"
          className="pokedex-theme-toggle-star7"
        />
        <rect
          x="37"
          y="12"
          ...
          fill="white"
          className="pokedex-theme-toggle-star8"
        />
        <rect
          x="68"
          y="12"
          ...
          fill="white"
          className="pokedex-theme-toggle-star9"
        />
        <rect
          x="94"
          y="10"
          ...
          fill="white"
          className="pokedex-theme-toggle-star10"
        />
        <rect
          x="79"
          y="22"
          ...
          transform="rotate(-45 79 22.4142)"
          fill="white"
          className="pokedex-theme-toggle-star11"
        />
        <rect
          x="52"
          y="19"
          ...
          fill="white"
          className="pokedex-theme-toggle-star12"
        />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          ...
          fill="#FFF3CA"
          className="pokedex-theme-toggle-moon"
        />
      </g>
      <defs>
        <linearGradient
          id="theme-toggle-background"
          x1="85"
          y1="0"
          x2="85"
          y2="70"
        ...
        >
          ...
          <stop
            offset="1"
            stopColor="#C3EFF8"
            className="pokedex-theme-toggle-background-bottom-color"
          />
        </linearGradient>
        <radialGradient
          id="pokedex-theme-toggle-sun-gradient"
          cx="0"
          cy="0"
          r="1"
          gradientUnits="userSpaceOnUse"
